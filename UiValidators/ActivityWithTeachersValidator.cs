...
{
    public class ActivityWithTeachersValidator : AbstractValidator<ActivityWithTeachersViewModel>
    {
        private readonly ApplicationDbContext _context;

        public ActivityWithTeachersValidator(ApplicationDbContext context)
        {
            _context = context;
